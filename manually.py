...
def surface_distane(c1: ti.template(), c2: ti.template(), r1: ti.f32, r2: ti.f32) -> ti.f32:
    return tm.distance(c1, c2) - (r1+r2)


@ti.kernel
def surface_distane_glsl(c1: ti.template(), c2: ti.template(), r1: ti.f32, r2: ti.f32) -> ti.f32:
...
print(surface_distane(c11, c12, r11, r12))
print(surface_distane_glsl(c11, c12, r11, r12))
